    ...
    <DashboardLayout>
      <div className="p-6 space-y-6">
        <div className="flex justify-between items-center">
          ...
          <Button className="bg-gradient-primary shadow-glow gap-1" onClick={handleSave} disabled={saving}>
        ...
        <Tabs defaultValue="profile" className="space-y-6">
          ...
          <TabsContent value="profile">
            <Card className="bg-card/50 border-border/50">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2 pt-2">
                      <Badge className="capitalize">{user?.role?.replace('_', ' ') || 'student'}</Badge>
                    </div>
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <Label>Bio</Label>
                  <Textarea placeholder="A short bio about yourself..." defaultValue="" />
                </div>
                    ...
                    {[
                      ...
                      <button
                        ...
                        className={`p-4 rounded-lg border text-center space-y-2 transition-all ${
                          theme === t.value ? 'border-primary bg-primary/10 ring-2 ring-primary/30' : 'border-border/50 hover:border-border hover:bg-muted/30'
                        }`}
                      >
          ...
          <TabsContent value="audio-video">
            <Card className="bg-card/50 border-border/50">
              ...
              <CardContent className="space-y-6">
                <div className="space-y-2">
                  <Label className="flex items-center gap-2"><Camera className="w-4 h-4" /> Camera</Label>
                ...
                <div className="space-y-2">
                  <Label className="flex items-center gap-2"><Mic className="w-4 h-4" /> Microphone</Label>
                  <Select defaultValue="default">
                    <SelectTrigger><SelectValue /></SelectTrigger>
                    <SelectContent>
                ...
                <div className="space-y-2">
                  <Label className="flex items-center gap-2"><Volume2 className="w-4 h-4" /> Speaker</Label>
                  <Select defaultValue="default">
                    <SelectTrigger><SelectValue /></SelectTrigger>
                    <SelectContent>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">AI-powered background noise removal</p>
                  </div>
                  <Switch defaultChecked />
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Stream at 720p or higher</p>
                  </div>
                  <Switch defaultChecked />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Use blur or custom backgrounds</p>
                  </div>
                  <Switch />
                </div>
              </CardContent>
            ...
            <Card className="bg-card/50 border-border/50">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="p-4 bg-destructive/10 border border-destructive/20 rounded-lg">
                  ...
                  <p className="text-xs text-muted-foreground mt-1 mb-3">Permanently delete your account and all data</p>
