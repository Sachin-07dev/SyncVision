      ...
      <div className="pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in max-w-4xl mx-auto">
            <div className="w-20 h-20 bg-gradient-primary rounded-3xl flex items-center justify-center shadow-glow mx-auto mb-6">
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="bg-gradient-to-br from-primary/10 to-secondary/10 border-primary/20 text-center">
                <CardContent className="p-8">
                  <div className="w-16 h-16 bg-gradient-primary rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4 shadow-glow">
                    1
                  </div>
                  <h3 className="text-xl font-semibold mb-3">Write or Draw</h3>
                  <p className="text-muted-foreground">
                    Start working on your problem or code on the whiteboard
                  </p>
                </CardContent>
              </Card>

              <Card className="bg-gradient-to-br from-secondary/10 to-primary/10 border-secondary/20 text-center">
                <CardContent className="p-8">
                  <div className="w-16 h-16 bg-gradient-secondary rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4 shadow-glow">
                    2
                  </div>
                  <h3 className="text-xl font-semibold mb-3">Ask AI</h3>
                  <p className="text-muted-foreground">
                    Click the AI Tutor button and ask your question
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-primary/10 to-secondary/10 border-primary/20 text-center">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground">
                    Receive instant, contextual guidance and explanations
                  </p>
                </CardContent>
              </Card>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-lg">
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Students:</strong> Get help with homework, understand concepts better,
                      and prepare for exams with AI-powered explanations.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 flex-shrink-0 mt-1" />
                    <div>
                      <strong>Developers:</strong> Debug code faster, learn best practices, and
                      optimize your solutions with intelligent code analysis.
                    </div>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 flex-shrink-0 mt-1" />
                    <div>
                      <strong>Educators:</strong> Provide personalized support to students at scale
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 flex-shrink-0 mt-1" />
                    <div>
                      <strong>Teams:</strong> Onboard new members faster and maintain code quality
                      with instant expert feedback.
                    </div>
                  </div>
                </div>
              </div>
